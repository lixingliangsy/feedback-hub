...
const steps = [
  { n: "1", t: "Paste", d: "Paste feedback one line per note (optional product name)." },
  { n: "2", t: "Cluster", d: "Group into themes with counts." },
  { n: "3", t: "Decide", d: "Use the build-next suggestion as a hypothesis, not destiny." },
]

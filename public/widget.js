 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="feedback-hub" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "feedback-hub";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "feedback-hub") + "_chat_session";

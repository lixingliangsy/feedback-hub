    ...
    <Layout>
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-slate-600 mb-10">
          FeedbackHub processes the inputs you submit for analysis. This page states, plainly, what we handle and what we do not claim.
        </p>

        <Sec title="What we handle">
          <p>user feedback lines you paste for theme clustering. Avoid pasting personal data you should not process.</p>
        </Sec>
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 mb-10 text-sm text-amber-900">
          <strong>Honesty rule:</strong> FeedbackHub clusters themes from text you provide. It does not guarantee the right roadmap, 100% perfect sentiment, or that you will never miss a theme. Do not fabricate user testimonials from outputs. We do <strong>not</strong> claim guarantee / 100% / never miss.
        </div>

        <Sec title="Our compliance posture">
          <ul className="list-disc pl-5 space-y-1">
            <li>FeedbackHub is <strong>decision-support</strong>, not a law firm, clinic, or certified auditor.</li>
        ...
        <p className="text-xs text-slate-400 mt-8">
          refs: schema.org Question / FAQPage · Nielsen Norman Group — affinity diagramming · FTC endorsements / testimonials guidance
        </p>
      </div>
    </Layout>
  )

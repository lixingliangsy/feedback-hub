...
export default function Home() {
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      ...
      for (const k of ['commits', 'text', 'article', 'endpoints', 'notes', 'goal', 'topic', 'industry', 'products', 'brand', 'resume', 'jd', 'data', 'log', 'citation', 'comps', 'prospect', 'system', 'role', 'region', 'seniority', 'diff', 'product', 'client', 'amount', 'days_overdue', 'tone', 'emails', 'config_text', 'scope', 'feedback']) {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://feedback-hub.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is FeedbackHub?", "acceptedAnswer": {"@type": "Answer", "text": "A tool that groups scattered user feedback into themes with a frequency count and suggests a 'build next' item."}}, {"@type": "Question", "name": "Where can feedback come from?", "acceptedAnswer": {"@type": "Answer", "text": "You can paste lines from Slack, DMs, or surveys."}}, {"@type": "Question", "name": "Does it count frequency?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Each theme carries a frequency count so you see what repeats."}}, {"@type": "Question", "name": "What is the build-next pick?", "acceptedAnswer": {"@type": "Answer", "text": "It is a suggested first roadmap item derived from the most frequent themes."}}, {"@type": "Question", "name": "Do I need a spreadsheet?", "acceptedAnswer": {"@type": "Answer", "text": "No. It is built to replace the manual spreadsheet synthesis."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Solo founders and small teams who collect feedback everywhere but never turn it into a roadmap."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">FeedbackHub - definition</h2>
...
<section id="features" className="py-20">
        ...
        <section id="studio" className="py-20">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-4">Trusted by solo founders</h2>
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Social proof uses templates until real, consented testimonials exist. Trusted by <strong>[X]+</strong> solo founders and small product teams.
            </p>
